...
figHist = px.histogram(x=["1700-1899", "1900-1949", "1950-1969", "1970-2000", "2000-2009", "2010-2015"],
                        y=[moyenne['1700'], moyenne['1900'], moyenne['1950'], moyenne["1970"], moyenne['2000'], moyenne["2010"]])
